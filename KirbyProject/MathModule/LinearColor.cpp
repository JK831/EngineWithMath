...
const LinearColor LinearColor::Silver(0.4f, 0.4f, 0.4f, 1.f);
const LinearColor LinearColor::WhiteSmoke(0.96f, 0.96f, 0.96f, 1.f);
const LinearColor LinearColor::LightGray(0.83f, 0.83f, 0.83f, 1.f);
const LinearColor LinearColor::DimGray(0.41f, 0.41f, 0.41f, 1.f);
