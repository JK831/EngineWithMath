#pragma once
	...
	public:
		...
		FORCEINLINE Matrix3x3 Invert() const
		{
			...
			//// I에 기록되었던 연산들을 차례대로 더해주면 U 완성
			//U.Raws[1][0] += record_1_0;
			//U.Raws[2][0] += record_2_0;
			//U.Raws[2][1] += record_2_1;

			//// det(AB) = det(A) * det(B)
			//// 상삼각, 하삼각행렬의 행렬식 = 대각 성분의 곱
			//float d = L.Raws[0][0] * L.Raws[1][1] * L.Raws[2][2] * U.Raws[0][0] * U.Raws[1][1] * U.Raws[2][2];
